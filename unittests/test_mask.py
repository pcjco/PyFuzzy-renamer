...
class mask_Tests(pfr.PyFuzzyRenamerTestCase):
    ...
    def test_mask(self):
        ...
        self.assertEqual(["[1984] The wiire_disk1", "68", "Wire, The", "Wire, The_disk1", "Matched", "True"], [lst.GetItemText(item, col) for col in range(0, len(pyfuzzyrenamer.default_columns))])
    ...
    def test_mask2(self):
        ...
        item = -1
        item = lst.GetNextItem(item)
        self.assertEqual(["[1984] The wiire_disk1", "89", "Wire, The", "[1984] Wire, The_disk1", "Matched", "True"], [lst.GetItemText(item, col) for col in range(0, len(pyfuzzyrenamer.default_columns))])
